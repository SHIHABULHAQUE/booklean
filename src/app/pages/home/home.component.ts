...
export class HomeComponent implements AfterViewInit, OnDestroy {
  ...
  readonly insightCards = [
    {
      id: 'corporate-tax', tabs: ['all', 'tax'], badge: '🔥 MOST READ - UAE CORPORATE TAX 2026', readTime: '10 min read', accent: '#ff4b4b', title: 'UAE Corporate Tax 9% — What Every UAE Business Must Do Right Now', body: 'UAE CT at 9% applies to taxable income above AED 375,000. Registration is mandatory for all — penalty AED 10,000 for late filing. Free zone 0% only for QFZP with genuine substance. Small Business Relief available below AED 3M revenue.'
    }, {
      id: 'vat', tabs: ['all', 'tax', 'compliance'], badge: 'VAT · FTA COMPLIANCE · UAE 2026', readTime: '8 min read', accent: '#f59e0b', title: 'UAE VAT Filing — Deadlines, the 10 Most Costly Mistakes & What the FTA Audits', body: 'UAE VAT at 5% since January 2018. Mandatory registration above AED 375,000 turnover — AED 20,000 penalty for late registration. The FTA cross-references supplier and buyer records — one mistake in your return flags errors in another.'
    }, {
      id: 'peppol', tabs: ['all', 'compliance'], badge: '⚡ UAE E-INVOICING · PEPPOL · 2026', readTime: '7 min read', accent: '#8b5cf6', title: 'UAE Mandatory E-Invoicing 2026 — PEPPOL Compliance Guide for UAE Businesses', body: 'The UAE FTA is mandating structured XML e-invoicing for B2B and B2G transactions — PDF invoices sent by email will no longer be sufficient. Large businesses are in the first mandatory phase. Implementation requires system changes, access point selection, and ERP integration.'
    }, {
      id: 'mainland-freezone', tabs: ['all', 'business', 'growth'], badge: 'BUSINESS SETUP · MAINLAND VS FREE ZONE UAE', readTime: '12 min read', accent: '#06b6d4', title: 'Mainland vs Freezone UAE — The Honest Comparison Every Business Owner Needs', body: 'Mainland gives unrestricted UAE market access — free zone gives potential 0% CT but only for QFZP earning qualifying income. A free zone company whose mainland revenue exceeds 5% of total loses the exemption for the entire year. We have set up 300+ UAE companies across both structures.'
    }, {
      id: 'restaurant-vat', tabs: ['all', 'tax', 'industry'], badge: 'F&B - RESTAURANT & CAFÉ VAT UAE', readTime: '7 min read', accent: '#10b981', title: 'Restaurant & F&B VAT in UAE — Every Rule Every Owner Must Know', body: 'Dine-in and takeaway: 5% VAT. Staff meals free of charge: deemed supply — output VAT required. Alcoholic beverages: 5% VAT (no federal excise on alcohol — excise covers tobacco 100%, energy drinks 100%, carbonated drinks 50%). Tourism Dirham: NOT VATable. Tourist Tax Refund: NOT available for food & beverage — retail goods only.'
    }, {
