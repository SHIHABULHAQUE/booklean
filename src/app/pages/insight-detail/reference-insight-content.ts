export interface ReferenceInsightSection {
  title: string;
  body: string;
  points: string[];
}

export interface ReferenceInsightContent {
  tag: string;
  title: string;
  summary: string;
  sections: ReferenceInsightSection[];
}
    ...
    "sections": [
      {
        ...
        "body": "UAE VAT was introduced on 1 January 2018 at a standard rate of 5%. It is a consumption tax collected by businesses on behalf of the Federal Tax Authority (FTA). You charge VAT on your taxable sales (output VAT), and you reclaim VAT on your business purchases (input VAT). The difference goes to the FTA. The key concept: VAT is not a cost to your business — it is collected from your customers and passed to the government. The risk comes from getting the collection and reporting wrong.",
        "points": []
      },
      {
      ...
      },
      {
        ...
        "body": "The FTA conducts desk audits and field audits. Common triggers include: BookLean tip: The best audit defence is a clean, reconciled VAT return filed on time every period — with proper documentation for every input VAT claim. We build this for every client from day one. Sara runs a digital marketing agency in Business Bay. She'd been filing her own VAT returns using spreadsheets for two years. When the FTA sent a clarification notice about AED 180,000 in input VAT claims over 18 months, she had no organised documentation. BookLean reconstructed her records, provided a complete audit defence file with supplier TRN verification and input VAT schedule, and responded to the FTA on her behalf. The audit closed with zero additional liability and no penalties.",
        "points": [
    ...
    "sections": [
      {
        ...
        "body": "ESR was introduced in UAE in 2019 to ensure that companies earning certain types of income — called \"Relevant Activities\" — have genuine economic substance in the UAE and are not being used purely as paper entities to shift profits. If your company earns income from a Relevant Activity, you must demonstrate: adequate employees in UAE, adequate expenditure in UAE, core income-generating activities are conducted in UAE, and management and control exercised in UAE.",
        "points": []
      },
      {
        "title": "The 9 Relevant Activities Under ESR",
        "body": "Important: \"Holding Company\" is the most common trigger for UAE businesses. If your company holds shares in subsidiaries and earns dividends or capital gains, it is likely a Holding Company under ESR and must file — even if it has no employees.",
        "points": []
      },
      {
        "title": "UBO Registry — Who Must Register",
        "body": "All UAE companies (mainland and most free zones) must maintain an internal UBO (Ultimate Beneficial Owner) register and file it with their licensing authority. A UBO is any natural person who ultimately owns or controls 25% or more of the company, directly or indirectly. Penalty for missing UBO filing: AED 100,000 for first offence — AED 200,000 for repeat offence (Cabinet Decision No. 109 of 2023). The UBO register must be updated within 15 days of any change in ownership.",
        "points": []
      },
      {
        "title": "AML Compliance — Who Is Obligated in UAE",
        "body": "Under UAE AML law, Designated Non-Financial Businesses and Professions (DNFBPs) must register on the goAML portal and have an AML compliance programme in place. DNFBPs include: BookLean is a registered DNFBP. We maintain full AML compliance programmes for ourselves and help our clients understand their own AML obligations — particularly real estate, financial services, and trading company clients. Book a free 30-minute strategy call with a senior BookLean CA. We'll review your current tax position, identify compliance gaps, and tell you exactly what your business needs.",
        "points": [
    ...
    "sections": [
      {
        ...
        "body": "Transfer pricing refers to the prices charged between related parties (group companies, related companies, associates) for goods, services, intellectual property, and financing. UAE Corporate Tax law requires that all transactions between related parties are conducted at arm's length — meaning at the same price that would apply between independent parties in the open market. Why it matters: If a UAE company pays excessive management fees to a parent company or charges below-market prices to a related party, the FTA can adjust the taxable income of the UAE entity to reflect arm's length pricing — potentially creating significant additional CT liability.",
        "points": []
      },
      {
        "title": "Who Must Comply with UAE Transfer Pricing Rules?",
        "body": "All UAE taxable persons with related party transactions must apply the arm's length principle. Additionally, specific documentation requirements apply if: If these thresholds are met, you must prepare and maintain a Local File and, in certain cases, a Master File — both prepared in accordance with OECD Guidelines.",
        "points": [
  ...
  "startup-uae": {
    ...
    "sections": [
      ...
      },
      {
        ...
        "body": "Book a free 30-minute strategy call with a senior BookLean CA. We'll review your current tax position, identify compliance gaps, and tell you exactly what your business needs. Book a free 30-minute strategy call. We'll review your position, find compliance gaps, and tell you exactly what your business needs.",
        "points": [
  ...
  "golden-visa": {
    ...
    "sections": [
      ...
      },
      {
        ...
        "body": "UAE has no personal income tax. For business owners and professionals from high-tax jurisdictions, UAE tax residency can legitimately reduce their global tax burden — but only if structured correctly and in compliance with the home country's tax rules. Important: UAE tax residency requires genuine physical presence (at least 183 days per year in UAE) and financial substance in UAE. Simply holding a Golden Visa without genuine UAE residence does not establish tax residency in most jurisdictions. BookLean can help: We prepare UAE Tax Residency Certificates from the Ministry of Finance for clients who qualify — which is the official document required to claim UAE tax treaty benefits in your home country.",
        "points": []
      }
    ]
  },
  ...
  "healthcare-vat": {
    ...
    "sections": [
      ...
      },
      {
        ...
        "body": "UAE VAT law zero-rates healthcare services that are preventive or curative and provided by a licensed healthcare provider. Qualifying services include: Key rule: Zero-rating requires the service to be provided by a licensed healthcare provider under UAE DHA, DOH, or equivalent authority. Services provided by unlicensed individuals or facilities do not qualify.",
        "points": [
      ...
      },
      {
        ...
        "body": "When a patient's treatment is covered by health insurance, the flow of VAT depends on the structure of the arrangement: Common mistake: Some clinics apply different VAT treatment to insured vs self-pay patients. The VAT treatment follows the nature of the service , not the payment method. A zero-rated medical service is zero-rated whether paid by insurance, cash, or credit card.",
        "points": [
  ...
  "freelancer-tax": {
    ...
    "sections": [
      ...
      },
      {
        ...
        "body": "UAE Corporate Tax at 9% applies to individuals conducting business activities through a trade licence, freelance permit, or sole establishment. If your annual net business profit exceeds AED 375,000, you pay 9% on the amount above that threshold. However, most freelancers in UAE qualify for Small Business Relief — which means zero tax if your total revenue is below AED 3 million for the tax period (for periods ending on or before 31 December 2026). You must still register: Small Business Relief does not exempt you from CT registration. Every freelance and sole establishment holder must register for Corporate Tax with the FTA — failure to do so triggers a mandatory AED 10,000 penalty.",
        "points": []
      },
      {
      ...
      },
      {
        ...
        "body": "UAE CT law allows deduction of expenses that are wholly, exclusively, and necessarily incurred for the purpose of the business. For freelancers, qualifying deductions typically include: What you cannot deduct: Personal expenses mixed with business, entertainment above 50% of actual cost, fines and penalties, capital items (these are depreciated not expensed), and personal income tax paid in another country.",
        "points": [
