...
export class RegionSelectorComponent {
    regions = [
        {
            id: 'india', name: 'INDIA', path: '/in/home', imageUrl: 'https://images.unsplash.com/photo-1524492412937-b28074a5d7da?auto=format&fit=crop&q=80&w=800' // Taj Mahal / India concept
        }, {
            ...
            id: 'uk', name: 'UK', path: '/uk/home', imageUrl: 'https://images.unsplash.com/photo-1513635269975-59663e0ac1ad?auto=format&fit=crop&q=80&w=800' // Big Ben / London concept
        }
    ];
}
